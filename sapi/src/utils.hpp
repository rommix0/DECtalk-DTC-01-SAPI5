// utils.hpp - small string-conversion and COM-output-pointer helpers used by
// com.hpp. Adapted from BstSpeech-sapi-master's src/utils.hpp (namespace
// Bestspeech -> dectalk); no DECtalk-specific logic.
#pragma once
