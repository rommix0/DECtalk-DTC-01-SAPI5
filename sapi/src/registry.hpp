// registry.hpp - RAII wrapper around a registry key (open/create, read/write
// string values, delete a subkey). Adapted from BstSpeech-sapi-master's
// src/registry.hpp (namespace Bestspeech -> dectalk); the RegKey helper API
// itself is unchanged, and carries no DECtalk-specific logic.
#pragma once
